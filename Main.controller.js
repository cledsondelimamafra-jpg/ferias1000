sap.ui.define([
    ...
    return Controller.extend("ferias1000.Main", {
        ...
        onInit: function () {
            // Inicializa o modelo de dados na raiz
            ...
            // Tenta carregar dados salvos anteriormente no navegador
            try {
        ...
        onAfterRendering: function () {
            // Desenha o mapa de forma segura quando a tela HTML estiver pronta
        ...
        _inicializarMapaLeaflet: function () {
            ...
            try {
                // Instancia o mapa apontando para o container id do HTML
        ...
        onFileChange: function() { /* Lógica de upload opcional */ },
        onSalvarDocumento: function() { /* Gravação local opcional */ },
        onSalvarReserva: function() { /* Gravação local opcional */ },
        onSalvarPassagem: function() { /* Gravação local opcional */ },
        onVerItem: function() { /* Visualizar item do PWA */ },
        onDeletarItem: function() { /* Remover item do PWA */ }
    });
});
